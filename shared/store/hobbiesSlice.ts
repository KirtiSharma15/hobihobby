 ...
 * 
 * For Phase 1, save/unsave hobbies works locally.
...
// Phase 2+ async thunks (commented out for now)
// export const saveHobby = createAsyncThunk(...);
// export const unsaveHobby = createAsyncThunk(...);
// export const completeHobby = createAsyncThunk(...);
// export const rateHobby = createAsyncThunk(...);
// export const fetchSavedHobbies = createAsyncThunk(...);
// export const fetchCompletedHobbies = createAsyncThunk(...);
